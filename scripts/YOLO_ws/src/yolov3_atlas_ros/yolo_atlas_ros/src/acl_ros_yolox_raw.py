...
class object_detect_node(object):
    def __init__(self):
        self.image_sub = rospy.Subscriber('/iris_0/realsense_camera/color/image_raw/compressed', sensor_msgs.msg.CompressedImage, self.image_receiver)
...
if __name__ == '__main__':
    rospy.init_node('atlas_yolox_opcv_node_endeffect', anonymous=False)
    acl_resource = AclResource()
    acl_resource.init()
    acl.rt.set_device(0)
